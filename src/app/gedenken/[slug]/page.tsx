    ...
    <div className="min-h-screen bg-[#faf9f6] flex flex-col relative selection:bg-sage-200">
      ...
      {isPreview && (
        <div className="bg-slate-900 text-white text-xs sm:text-sm font-medium py-3 px-4 text-center sticky top-0 z-50 flex justify-center items-center gap-4">
          <span className="opacity-90 font-light tracking-wide">Dies ist eine private Vorschau. Aktiviere sie für den Grab-Scan.</span>
          <a href={`/dashboard/unlock/${memorial.id}`} className="bg-white text-slate-900 px-4 py-1.5 rounded-full text-xs font-semibold hover:bg-sage-100 transition shadow-sm whitespace-nowrap">
            Freischalten (19 CHF)
          </a>
        </div>
      )}

      {/* Elegant Hero Image Area */}
      <div className="relative w-full h-[45vh] md:h-[60vh] bg-stone-300 overflow-hidden">
        ...
        <div className="absolute bottom-0 w-full p-8 md:p-16 text-center animate-slide-up">
          ...
          <p className="text-white/80 font-light tracking-widest uppercase text-xs md:text-sm mt-3">
      ...
      <main className="flex-grow max-w-3xl mx-auto w-full px-6 py-12 md:py-24 animate-fade-in" style={{ animationDelay: '0.3s', animationFillMode: 'both' }}>
        ...
        <div className="text-center mb-20">
          ...
          <div className="text-left text-slate-600 leading-loose space-y-6 font-light">
            <p>
              Hier entsteht ein digitaler Raum für Erinnerungen. 
              Dies ist der Platz für eine liebevolle Kurzbiografie, besondere Lebensstationen und Momente, die für immer in unseren Herzen bleiben.
            </p>
          </div>
        </div>
