    ...
    <div className="flex-grow flex flex-col items-center bg-stone-50 overflow-hidden">
      ...
      <section className="relative w-full px-4 pt-32 pb-16 md:pt-48 md:pb-24 flex flex-col items-center text-center bg-stone-50 overflow-visible z-10">
        ...
        <div className="max-w-4xl relative z-10 flex flex-col items-center animate-fade-in">
          ...
          <h2 className="font-script text-3xl md:text-5xl text-brand-primary mb-6 tracking-wide drop-shadow-sm">
            Die moderne Art des Gedenkens
          </h2>

          <h1 className="text-5xl md:text-7xl lg:text-[5rem] font-heading font-bold text-brand-navy mb-8 leading-[1.1] tracking-tight">
            Erinnerungen, die <br className="hidden md:block" />
            <span className="text-brand-primary">niemals verblassen.</span>
          </h1>

          <p className="text-lg md:text-xl text-slate-500 max-w-2xl mx-auto mb-10 leading-relaxed font-sans font-light">
      ...
      <section className="w-full max-w-7xl mx-auto px-6 lg:px-8 pb-32">
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-stretch justify-center">
          ...
          <div className="w-full lg:w-[32%] flex flex-col gap-6 lg:gap-8 lg:mt-16">
            ...
            <div className="bg-white rounded-[2rem] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all border border-slate-100/50 flex flex-col items-center text-center relative overflow-hidden h-[340px]">
              ...
              <div className="w-full flex-grow relative mb-4">
                ...
                <div className="absolute bottom-[-15px] left-1/2 -translate-x-1/2 w-[220px] shadow-xl rounded-xl z-20 hover:scale-105 transition-transform duration-300">
                  <div className="bg-brand-100 border border-white p-4 rounded-xl shadow-lg border-opacity-50">
                    <p className="text-[11px] font-bold text-brand-primary text-left">In 10 Minuten fertig</p>
                    <p className="text-[9px] text-brand-primary/80 text-left mt-1">Gedenkseite erstellen, Foto hochladen und Seite fixieren</p>
                  </div>
                </div>
              </div>

              <h3 className="font-heading text-brand-navy text-xl mb-2 relative z-10 font-semibold">QR-Medaillon</h3>
              <p className="text-sm text-slate-500 relative z-10 leading-relaxed font-sans font-light">Wetterfest und hochwertig — direkt am Grabstein, der Urne oder einer Gedenktafel anbringen.</p>
            </div>

            {/* Bottom Left: Gravestones (Image) */}
            <div className="bg-stone-900 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.06)] overflow-hidden relative h-[250px] group">
              <div className="absolute inset-0 w-full h-full bg-slate-800">
                <Image src="/images/startseite/gravestones.png" alt="Grabsteine" fill className="object-cover opacity-60 group-hover:opacity-80 transition-opacity duration-700 blur-[2px] group-hover:blur-0" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent"></div>
              </div>
              <div className="absolute bottom-0 left-0 p-8 w-full z-10">
                <h3 className="text-white font-heading font-medium text-xl mb-2 leading-tight drop-shadow-md">Ein würdevoller Ort der Erinnerung</h3>
                <p className="text-white/80 text-sm font-sans font-light drop-shadow-sm">Damit die, die nicht da sein können, trotzdem teilhaben.</p>
              </div>
            </div>
          ...
          <div className="w-full lg:w-[36%] flex justify-center lg:items-start lg:-mt-12 z-20">
            <div className="relative w-full max-w-[340px] aspect-[1/2.16] rounded-[2.5rem] shadow-[0_40px_80px_rgba(30,43,94,0.15)] border-[8px] border-black bg-white overflow-hidden transform hover:-translate-y-3 transition-transform duration-700 ease-out mx-auto group">
              {/* Top Notch Area */}
